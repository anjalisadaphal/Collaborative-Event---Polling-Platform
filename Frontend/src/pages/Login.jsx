...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-[calc(100vh-80px)] relative overflow-hidden">
            ...
            <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
